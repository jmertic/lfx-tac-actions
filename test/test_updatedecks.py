...
class TestUpdateDecks(unittest.TestCase):
    ...
    def testMain(self):
        ...
        responses.get(
            url=re.compile(r'^https://docs\.google\.com/feeds/download/presentations/Export\?id=.*$'),
            body="blah blah blah")
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            self.assertTrue(os.path.isfile(Path(tempdir,"ASWF Membership Overview.pdf")))
            ...
            self.assertTrue(os.path.isfile(Path(tempdir,"ASWF Membership Overview.pptx")))
